...
TRANSLATE_CONFIG_KEYS = [
    ...
    "providers.openai_compatible.translation_base_url",
    "providers.openai_compatible.translation_model",
]
VOICE_CLONE_CONFIG_KEYS = [
    ...
    "providers.dashscope.tts_clone_model",
    "providers.dashscope.tts_enrollment_model",
    "providers.vllm_omni.model",
    "providers.vllm_omni.language",
    "providers.vllm_omni.instructions",
    "providers.vllm_omni.x_vector_only_mode",
    "providers.qwen_local.clone_model_size",
    "providers.qwen_local.torch_dtype",
    "providers.qwen_local.attn_implementation",
...
TTS_CONFIG_KEYS = [
    "tts.provider",
    "tts.mode",
    "providers.dashscope.tts_base_url",
    "providers.dashscope.tts_preset_model",
    "providers.dashscope.tts_clone_model",
    "providers.openai_compatible.tts_base_url",
    "providers.openai_compatible.tts_model",
    "providers.vllm_omni.base_url",
    "providers.vllm_omni.model",
    "providers.vllm_omni.language",
    "providers.vllm_omni.instructions",
    "providers.vllm_omni.x_vector_only_mode",
    "providers.qwen_local.clone_model_size",
    "providers.qwen_local.preset_model_size",
    "providers.qwen_local.device",
    "providers.qwen_local.torch_dtype",
    "providers.qwen_local.attn_implementation",
    "providers.qwen_local.language",
    "providers.qwen_local.instructions",
